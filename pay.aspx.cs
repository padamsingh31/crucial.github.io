...
public partial class pay : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txnid.Value = "CC" + txnid.Value.ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       String text = key.Value.ToString() + "|" + txnid.Value.ToString() + "|" + amount + "|" + "Movie Ticket" + "|" + TextBox1.Text + "|" + TextBox2.Text + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "||||||" + salt.Value.ToString();
        Response.Write(text);
        ...
        data.Add("productinfo", "Movie Ticket");
        data.Add("udf1", "1");
        data.Add("udf2", "1");
        data.Add("udf3", "1");
        data.Add("udf4", "1");
        ...
        data.Add("surl", "http://localhost:7689/crucial%20cinemanew2/paymentsuccess.aspx");
        data.Add("furl", "http://localhost:7689/crucial%20cinemanew2/paymentfail.aspx");
